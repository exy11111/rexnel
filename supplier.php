										...
										<div class="row align-items-center">
											...
											<div class="col col-stats ms-3 ms-sm-0">
												<div class="numbers">
													...
													<h4 class="card-title">₱<?php echo number_format($revenue_month ?? 0.00, 2); ?></h4>
												</div>
											</div>
										</div>
									</div>
													...
													if (!empty($data)) {
														foreach($data as $row){
															...
															switch ($status) {
																...
																case 'Accepted':  $badgeClass = 'bg-primary'; break;
																case 'Shipping':  $badgeClass = 'bg-info text-dark'; break;
																case 'Delivered': $badgeClass = 'bg-success'; break;
																case 'Received':  $badgeClass = 'bg-secondary'; break;
